    ...
    \begin{frame}
        ...
        \begin{figure}
            \begin{subfigure}[t]{.4\textwidth}
                ...
                \subcaption{LED grow light. From: \textcite{noauthor_phlizon_fd6000-640w-upgraded_nodate}}
            \end{subfigure}
            \hfill
            \begin{subfigure}[t]{.4\textwidth}
                \includegraphics[width=\linewidth]{LuxElite_PlantUV}
                \subcaption{UV grow light. From: \textcite{noauthor_luxelite_plantuv_nodate}}
            \end{subfigure}
        \end{figure}
    \end{frame}

...
\titlegraphic{\includegraphics[width=2cm,height=2cm]{../figures/qrcode_presentation-on-github}}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{columns}[t]
            \begin{column}[T]{.55\textwidth}
                \includegraphics[width=\linewidth]{../figures/plant_all_2024-06-17}
            \end{column}
    ...
    \begin{frame}
        ...
        \begin{columns}[t]
            \begin{column}[T]{.55\textwidth}
                \begin{figure}
                    \includegraphics[width=\linewidth]{../figures/jeremy-bishop-EdSdhvPX36M-unsplash}
    ...
    \begin{frame}
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}[t]{0.45\textwidth}
                \begin{subfigure}[t]{0.99\textwidth}
                    \includegraphics[width=\linewidth]{../figures/plant_ctrl_2024-06-17}
                \end{subfigure}
                \caption{Control group}
            \end{minipage}
        \end{figure}
